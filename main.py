...
rotatedpipe = pygame.image.load("rotated_pipe.png").convert_alpha()

#sounds                                                                                                                                                                   
point = pygame.mixer.Sound("sounds_sfx_point.wav")
...
class Game:
    ...
    def mainGame(self):
        while self.gameOn:
            ...
            self.gameOver()
            #displaying score
            self.screenText(str(self.score), (255,255,255), 600, 50, 100, "Fixedsys", bold=True)
